defmodule BlogApp.CommentsTest do
  ...
  describe "comments" do
    ...
    @create_attrs %{content: "some content", name: "some name", post_id: "some id"}
    @invalid_attrs %{content: nil, name: nil, post_id: nil}
    ...
    test "create_comment/1 with valid data creates a comment" do
      ...
      assert {:ok, %Comment{} = comment} = Comments.create_comment(@create_attrs)
